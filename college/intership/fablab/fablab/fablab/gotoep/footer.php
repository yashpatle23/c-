		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						<br>
						Copyrights &copy; 2022 All Rights Reserved by Datanoid<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> sahilmohurale03@gmail.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> 8830568867  <span class="middot"></span>
					</div>
